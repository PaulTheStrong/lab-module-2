...
public class ExceptionCodes {
    public static final String CERTIFICATE_NAME_MUST_BE_SPECIFIED = "40001";
    public static final String CERTIFICATE_NAME_LENGTH_CONSTRAINT = "40002";
    public static final String CERTIFICATE_DESCRIPTION_LENGTH_CONSTRAINT = "40003";
    public static final String CERTIFICATE_PRICE_MUST_BE_SPECIFIED = "40005";
    public static final String CERTIFICATE_PRICE_MUST_BE_POSITIVE = "40004";
    public static final String CERTIFICATE_DURATION_MUST_BE_POSITIVE = "40006";
    public static final String CERTIFICATE_DURATION_MUST_BE_SPECIFIED = "40007";
